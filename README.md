...
Great.  Now, let's check that everything loaded correctly. 

In the following cells, display the head of each of the DataFrames that we created in the cell above.  
